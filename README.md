...
This is a sample template for sample-sam-api - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sample-sam-api --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sample-sam-api
```
